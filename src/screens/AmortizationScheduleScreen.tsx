...
function Field(p:{label:string;value:string;onChangeText:(v:string)=>void;placeholder?:string;keyboardType?:'default'|'numeric';multiline?:boolean}){return <View style={styles.field}><Text style={styles.fieldLabel}>{p.label}</Text><TextInput style={[styles.input,p.multiline&&styles.multiline]} value={p.value} onChangeText={p.onChangeText} placeholder={p.placeholder} placeholderTextColor="#7D8492" keyboardType={p.keyboardType||'default'} multiline={p.multiline}/></View>}
const styles=StyleSheet.create({container:{flex:1,backgroundColor:'#FFD83D'},content:{width:'100%',paddingHorizontal:28,paddingTop:24,paddingBottom:48},header:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginBottom:18,padding:20,borderRadius:18,backgroundColor:'#FFF0A8',borderWidth:1,borderColor:'#E7C33A'},headerLeft:{flexDirection:'row',alignItems:'center',flex:1},backButton:{width:40,height:40,borderRadius:12,backgroundColor:'#FFF0A84B8',alignItems:'center',justifyContent:'center',marginRight:12},backButtonText:{fontSize:33,lineHeight:30,color:'#171A24'},title:{fontFamily:'Inter_800ExtraBold',fontSize:28,color:'#171A24'},subtitle:{marginTop:4,fontFamily:'Inter_400Regular',fontSize:13,color:'#4D5566'},saveButton:{marginLeft:14,paddingHorizontal:16,paddingVertical:11,borderRadius:10,backgroundColor:'#171A24'},saveButtonText:{color:'#FFF0A8',fontFamily:'Inter_700Bold',fontSize:12},summary:{flexDirection:'row',flexWrap:'wrap',gap:12,marginBottom:18},summaryCard:{minWidth:180,flex:1,padding:16,borderRadius:16,backgroundColor:'#FFF0A8',borderWidth:1,borderColor:'#E7C33A'},summaryLabel:{fontFamily:'Inter_500Medium',fontSize:12,color:'#4D5566'},summaryValue:{marginTop:7,fontFamily:'Inter_800ExtraBold',fontSize:21,color:'#171A24'},toolbar:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',gap:14,marginBottom:12},sectionTitle:{fontFamily:'Inter_700Bold',fontSize:20,color:'#171A24'},sectionSubtitle:{marginTop:4,fontFamily:'Inter_400Regular',fontSize:12,color:'#4D5566'},addButton:{paddingHorizontal:15,paddingVertical:10,borderRadius:10,backgroundColor:'#171A24'},addButtonText:{fontFamily:'Inter_700Bold',fontSize:12,color:'#FFF0A8'},loading:{paddingVertical:50,alignItems:'center',gap:10},loadingText:{fontFamily:'Inter_500Medium',fontSize:13,color:'#4D5566'},empty:{padding:50,alignItems:'center'},emptyTitle:{fontFamily:'Inter_700Bold',fontSize:18,color:'#171A24'},emptyText:{marginTop:5,fontFamily:'Inter_400Regular',fontSize:13,color:'#4D5566'},tableScroll:{borderRadius:16},table:{minWidth:1500,borderRadius:16,overflow:'hidden',backgroundColor:'#FFF0A8',borderWidth:1,borderColor:'#E7C33A'},tableHeader:{flexDirection:'row',alignItems:'center',backgroundColor:'#FFC83D',paddingVertical:12,borderBottomWidth:1,borderBottomColor:'#E7C33A'},tableRow:{flexDirection:'row',alignItems:'center',minHeight:62,borderBottomWidth:1,borderBottomColor:'#E7C33A'},headerCell:{fontFamily:'Inter_700Bold',fontSize:11,color:'#4D5566'},cell:{fontFamily:'Inter_500Medium',fontSize:12,color:'#2B2410'},seq:{width:45,textAlign:'center'},type:{width:155,paddingHorizontal:10},date:{width:105,paddingHorizontal:8},money:{width:115,paddingHorizontal:8,textAlign:'right'},status:{width:135,paddingHorizontal:8},actions:{width:150,paddingHorizontal:8},statusArea:{justifyContent:'center'},checkButton:{paddingHorizontal:9,paddingVertical:7,borderRadius:9,backgroundColor:'#FCE4E4',borderWidth:1,borderColor:'#E9A3A3'},checkButtonPaid:{backgroundColor:'#E2F6EC',borderColor:'#B3DCC5'},checkButtonDisabled:{backgroundColor:'#F3F4F6',borderColor:'#E5E7EB'},checkText:{fontFamily:'Inter_700Bold',fontSize:11,color:'#D93636'},checkTextPaid:{color:'#159A68'},entryStatus:{fontFamily:'Inter_600SemiBold',fontSize:11,color:'#4D5566'},actionArea:{flexDirection:'row',alignItems:'center',gap:7},editButton:{paddingHorizontal:10,paddingVertical:7,borderRadius:8,backgroundColor:'#FFF0A84B8'},editButtonText:{fontFamily:'Inter_600SemiBold',fontSize:11,color:'#171A24'},deleteButton:{paddingHorizontal:10,paddingVertical:7,borderRadius:8,backgroundColor:'#FCE4E4'},deleteButtonText:{fontFamily:'Inter_600SemiBold',fontSize:11,color:'#D93636'},modalBackdrop:{flex:1,backgroundColor:'rgba(23,26,36,0.55)',alignItems:'center',justifyContent:'center',padding:20},modalCard:{width:'100%',maxWidth:620,maxHeight:'90%',backgroundColor:'#FFF0A8',borderRadius:18,padding:20},modalHeader:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginBottom:15},modalTitle:{fontFamily:'Inter_700Bold',fontSize:21,color:'#171A24'},closeText:{fontSize:33,color:'#4D5566'},field:{marginBottom:12},fieldLabel:{marginBottom:6,fontFamily:'Inter_600SemiBold',fontSize:12,color:'#2B2410'},input:{minHeight:44,borderWidth:1,borderColor:'#DCC43A',borderRadius:10,paddingHorizontal:12,fontFamily:'Inter_400Regular',fontSize:14,color:'#171A24',backgroundColor:'#FFF0A89D6'},multiline:{minHeight:70,paddingTop:10,textAlignVertical:'top'},typeChoices:{flexDirection:'row',flexWrap:'wrap',gap:7,marginBottom:15},typeChoice:{paddingHorizontal:10,paddingVertical:8,borderRadius:9,backgroundColor:'#FFF0A89D6',borderWidth:1,borderColor:'#E7C33A'},typeChoiceSelected:{backgroundColor:'#FFF0A84B8',borderColor:'#171A24'},typeChoiceText:{fontFamily:'Inter_600SemiBold',fontSize:11,color:'#4D5566'},typeChoiceTextSelected:{color:'#171A24'},modalSave:{marginTop:8,paddingVertical:12,borderRadius:10,backgroundColor:'#171A24',alignItems:'center'},modalSaveText:{fontFamily:'Inter_700Bold',fontSize:12,color:'#FFF0A8'}});
