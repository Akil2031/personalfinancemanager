...
export default function AmortizationScheduleScreen({loan,onBack}:Props){
 ...
 return <View style={styles.container}><ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
  <View style={styles.header}><View style={styles.headerLeft}>{onBack&&<Pressable style={styles.backButton} onPress={onBack}><Text style={styles.backButtonText}>â€¹</Text></Pressable>}<View><Text style={styles.title}>Amortization Schedule</Text><Text style={styles.subtitle}>{loan.loanName} â€¢ {loan.lender}</Text></View></View><Pressable style={styles.saveButton} onPress={()=>void save()} disabled={saving}>{saving?<ActivityIndicator size="small" color="#FFFFFF"/>:<Text style={styles.saveButtonText}>Save Schedule</Text>}</Pressable></View>
  <View style={styles.summary}><Summary label="Entries" value={String(rows.length)}/><Summary label="Scheduled Total" value={`â‚¹${money(totalScheduled)}`}/><Summary label="Principal Paid" value={`â‚¹${money(principalPaid)}`}/><Summary label="Interest Paid" value={`â‚¹${money(interestPaid)}`}/><Summary label="Paid" value={`â‚¹${money(totalPaid)}`}/><Summary label="Outstanding Principal" value={`â‚¹${money(outstanding)}`}/></View>
...
const styles=StyleSheet.create({container:{flex:1,backgroundColor:'#F5F7FB'},content:{width:'100%',paddingHorizontal:28,paddingTop:24,paddingBottom:48},header:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginBottom:18,padding:20,borderRadius:18,backgroundColor:'#FFF',borderWidth:1,borderColor:'#E3E8F1'},headerLeft:{flexDirection:'row',alignItems:'center',flex:1},backButton:{width:40,height:40,borderRadius:12,backgroundColor:'#EAF0FF',alignItems:'center',justifyContent:'center',marginRight:12},backButtonText:{fontSize:33,lineHeight:30,color:'#356DFF'},title:{fontFamily:'Inter_800ExtraBold',fontSize:28,color:'#172033'},subtitle:{marginTop:4,fontFamily:'Inter_400Regular',fontSize:13,color:'#738097'},saveButton:{marginLeft:14,paddingHorizontal:16,paddingVertical:11,borderRadius:10,backgroundColor:'#356DFF'},saveButtonText:{color:'#FFF',fontFamily:'Inter_700Bold',fontSize:12},summary:{flexDirection:'row',flexWrap:'wrap',gap:12,marginBottom:18},summaryCard:{minWidth:180,flex:1,padding:16,borderRadius:16,backgroundColor:'#FFF',borderWidth:1,borderColor:'#E3E8F1'},summaryLabel:{fontFamily:'Inter_500Medium',fontSize:12,color:'#738097'},summaryValue:{marginTop:7,fontFamily:'Inter_800ExtraBold',fontSize:21,color:'#172033'},toolbar:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',gap:14,marginBottom:12},sectionTitle:{fontFamily:'Inter_700Bold',fontSize:20,color:'#172033'},sectionSubtitle:{marginTop:4,fontFamily:'Inter_400Regular',fontSize:12,color:'#738097'},addButton:{paddingHorizontal:15,paddingVertical:10,borderRadius:10,backgroundColor:'#356DFF'},addButtonText:{fontFamily:'Inter_700Bold',fontSize:12,color:'#FFF'},loading:{paddingVertical:50,alignItems:'center',gap:10},loadingText:{fontFamily:'Inter_500Medium',fontSize:13,color:'#738097'},empty:{padding:50,alignItems:'center'},emptyTitle:{fontFamily:'Inter_700Bold',fontSize:18,color:'#172033'},emptyText:{marginTop:5,fontFamily:'Inter_400Regular',fontSize:13,color:'#738097'},tableScroll:{borderRadius:16},table:{minWidth:1500,borderRadius:16,overflow:'hidden',backgroundColor:'#FFF',borderWidth:1,borderColor:'#E3E8F1'},tableHeader:{flexDirection:'row',alignItems:'center',backgroundColor:'#F4F6FA',paddingVertical:12,borderBottomWidth:1,borderBottomColor:'#E3E8F1'},tableRow:{flexDirection:'row',alignItems:'center',minHeight:62,borderBottomWidth:1,borderBottomColor:'#EEF1F5'},headerCell:{fontFamily:'Inter_700Bold',fontSize:11,color:'#667085'},cell:{fontFamily:'Inter_500Medium',fontSize:12,color:'#344054'},seq:{width:45,textAlign:'center'},type:{width:155,paddingHorizontal:10},date:{width:105,paddingHorizontal:8},money:{width:115,paddingHorizontal:8,textAlign:'right'},status:{width:135,paddingHorizontal:8},actions:{width:150,paddingHorizontal:8},statusArea:{justifyContent:'center'},checkButton:{paddingHorizontal:9,paddingVertical:7,borderRadius:9,backgroundColor:'#FDECEC',borderWidth:1,borderColor:'#F5CACA'},checkButtonPaid:{backgroundColor:'#E8F7F0',borderColor:'#CBEBDC'},checkButtonDisabled:{backgroundColor:'#F3F4F6',borderColor:'#E5E7EB'},checkText:{fontFamily:'Inter_700Bold',fontSize:11,color:'#C0392B'},checkTextPaid:{color:'#168A61'},entryStatus:{fontFamily:'Inter_600SemiBold',fontSize:11,color:'#667085'},actionArea:{flexDirection:'row',alignItems:'center',gap:7},editButton:{paddingHorizontal:10,paddingVertical:7,borderRadius:8,backgroundColor:'#EEF3FF'},editButtonText:{fontFamily:'Inter_600SemiBold',fontSize:11,color:'#3156D3'},deleteButton:{paddingHorizontal:10,paddingVertical:7,borderRadius:8,backgroundColor:'#FDECEC'},deleteButtonText:{fontFamily:'Inter_600SemiBold',fontSize:11,color:'#C0392B'},modalBackdrop:{flex:1,backgroundColor:'rgba(15,23,42,0.35)',alignItems:'center',justifyContent:'center',padding:20},modalCard:{width:'100%',maxWidth:620,maxHeight:'90%',backgroundColor:'#FFF',borderRadius:18,padding:20},modalHeader:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginBottom:15},modalTitle:{fontFamily:'Inter_700Bold',fontSize:21,color:'#172033'},closeText:{fontSize:33,color:'#667085'},field:{marginBottom:12},fieldLabel:{marginBottom:6,fontFamily:'Inter_600SemiBold',fontSize:12,color:'#344054'},input:{minHeight:44,borderWidth:1,borderColor:'#DCE2EA',borderRadius:10,paddingHorizontal:12,fontFamily:'Inter_400Regular',fontSize:14,color:'#172033',backgroundColor:'#FBFCFE'},multiline:{minHeight:70,paddingTop:10,textAlignVertical:'top'},typeChoices:{flexDirection:'row',flexWrap:'wrap',gap:7,marginBottom:15},typeChoice:{paddingHorizontal:10,paddingVertical:8,borderRadius:9,backgroundColor:'#F2F4F7',borderWidth:1,borderColor:'#E4E7EC'},typeChoiceSelected:{backgroundColor:'#EEF3FF',borderColor:'#356DFF'},typeChoiceText:{fontFamily:'Inter_600SemiBold',fontSize:11,color:'#667085'},typeChoiceTextSelected:{color:'#3156D3'},modalSave:{marginTop:8,paddingVertical:12,borderRadius:10,backgroundColor:'#356DFF',alignItems:'center'},modalSaveText:{fontFamily:'Inter_700Bold',fontSize:12,color:'#FFF'}});
