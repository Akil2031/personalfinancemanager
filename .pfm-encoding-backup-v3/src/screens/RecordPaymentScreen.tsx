...
const styles = StyleSheet.create({
  ...
  loadingText: { marginTop: 8, fontFamily: 'Inter_500Medium', fontSize: 15, color: '#667085' },

  pageHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24, gap: 16 },
  title: { fontFamily: 'Inter_800ExtraBold', fontSize: 35, color: '#172033', letterSpacing: -0.6 },
  subtitle: { marginTop: 6, fontFamily: 'Inter_400Regular', fontSize: 15, color: '#667085' },
  ...
  addButtonText: { fontFamily: 'Inter_700Bold', fontSize: 14, color: '#FFFFFF' },
  ...
  summaryLabel: { fontFamily: 'Inter_500Medium', fontSize: 13, color: '#667085' },
  summaryValue: { marginTop: 10, fontFamily: 'Inter_800ExtraBold', fontSize: 26, color: '#172033', letterSpacing: -0.4 },
  ...
  formTitle: { fontFamily: 'Inter_700Bold', fontSize: 21, color: '#172033' },
  formSubtitle: { marginTop: 5, fontFamily: 'Inter_400Regular', fontSize: 13, color: '#667085' },
  closeButton: { width: 36, height: 36, borderRadius: 11, backgroundColor: '#F2F4F7', alignItems: 'center', justifyContent: 'center' },
  closeButtonText: { fontFamily: 'Inter_700Bold', fontSize: 17, color: '#667085' },
  label: { marginBottom: 8, fontFamily: 'Inter_600SemiBold', fontSize: 13, color: '#344054' },
  ...
  loanOptionName: { fontFamily: 'Inter_600SemiBold', fontSize: 14, color: '#344054' },
  loanOptionNameActive: { color: '#3156D3' },
  loanOptionLender: { marginTop: 4, fontFamily: 'Inter_400Regular', fontSize: 12, color: '#98A2B3' },
  loanOptionLenderActive: { color: '#5B6FAF' },
  input: { minHeight: 48, backgroundColor: '#FBFCFE', borderWidth: 1, borderColor: '#DCE2EA', borderRadius: 13, paddingHorizontal: 14, paddingVertical: 11, fontFamily: 'Inter_400Regular', fontSize: 15, color: '#172033', marginBottom: 18 },
  ...
  currency: { marginLeft: 16, fontFamily: 'Inter_700Bold', fontSize: 24, color: '#356DFF' },
  amountInput: { flex: 1, paddingHorizontal: 11, fontFamily: 'Inter_700Bold', fontSize: 26, color: '#172033' },
  ...
  scheduleLoadingText: { fontFamily: 'Inter_500Medium', fontSize: 12, color: '#667085' },
  ...
  scheduledLabel: { fontFamily: 'Inter_500Medium', fontSize: 12, color: '#667085' },
  scheduledValue: { marginTop: 4, fontFamily: 'Inter_700Bold', fontSize: 18, color: '#3156D3' },
  useEmiButton: { paddingHorizontal: 13, paddingVertical: 9, borderRadius: 10, backgroundColor: '#356DFF' },
  useEmiText: { fontFamily: 'Inter_600SemiBold', fontSize: 12, color: '#FFFFFF' },
  ...
  typeLabel: { fontFamily: 'Inter_600SemiBold', fontSize: 12, color: '#667085' },
  typeDescription: { marginTop: 4, fontFamily: 'Inter_500Medium', fontSize: 14, color: '#344054' },
  ...
  typeBadgeText: { fontFamily: 'Inter_700Bold', fontSize: 11, color: '#344054' },
  ...
  allocationTitle: { fontFamily: 'Inter_700Bold', fontSize: 17, color: '#172033', marginBottom: 10 },
  allocationRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6 },
  allocationLabel: { fontFamily: 'Inter_400Regular', fontSize: 13, color: '#667085' },
  allocationLabelStrong: { fontFamily: 'Inter_600SemiBold', color: '#344054' },
  allocationValue: { fontFamily: 'Inter_500Medium', fontSize: 13, color: '#344054' },
  allocationValueStrong: { fontFamily: 'Inter_700Bold', color: '#3156D3' },
  principalOnlyNote: { marginTop: 8, fontFamily: 'Inter_600SemiBold', fontSize: 12, color: '#168A61' },
  ...
  cancelButtonText: { fontFamily: 'Inter_600SemiBold', fontSize: 13, color: '#475467' },
  ...
  saveButtonText: { fontFamily: 'Inter_700Bold', fontSize: 13, color: '#FFFFFF' },
  ...
  historyTitle: { fontFamily: 'Inter_700Bold', fontSize: 21, color: '#172033' },
  historySubtitle: { marginTop: 5, fontFamily: 'Inter_400Regular', fontSize: 13, color: '#667085' },
  historyCount: { minWidth: 34, height: 34, borderRadius: 17, backgroundColor: '#EEF3FF', color: '#3156D3', textAlign: 'center', textAlignVertical: 'center', paddingTop: 9, fontFamily: 'Inter_700Bold', fontSize: 13 },
  searchInput: { height: 46, marginTop: 18, marginBottom: 14, borderWidth: 1, borderColor: '#DCE2EA', backgroundColor: '#FBFCFE', borderRadius: 13, paddingHorizontal: 14, fontFamily: 'Inter_400Regular', fontSize: 14, color: '#172033' },
  historyList: { gap: 10 },
  ...
  historyIconText: { color: '#356DFF', fontFamily: 'Inter_700Bold', fontSize: 20 },
  historyInfo: { flex: 1, minWidth: 0 },
  historyTitleRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  historyLoanName: { flexShrink: 1, fontFamily: 'Inter_600SemiBold', fontSize: 15, color: '#172033' },
  statusBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 999 },
  statusBadgeText: { fontFamily: 'Inter_700Bold', fontSize: 9, color: '#344054' },
  historyDate: { marginTop: 5, fontFamily: 'Inter_400Regular', fontSize: 12, color: '#98A2B3' },
  breakdown: { marginTop: 5, fontFamily: 'Inter_400Regular', fontSize: 12, color: '#667085' },
  notesText: { marginTop: 5, fontFamily: 'Inter_400Regular', fontSize: 12, color: '#98A2B3', fontStyle: 'italic' },
  historyRight: { alignItems: 'flex-end', marginLeft: 12 },
  historyAmount: { fontFamily: 'Inter_800ExtraBold', fontSize: 19, color: '#3156D3' },
  ...
  editButtonText: { fontFamily: 'Inter_600SemiBold', fontSize: 11, color: '#3156D3' },
  deleteButton: { paddingHorizontal: 10, paddingVertical: 7, borderRadius: 8, backgroundColor: '#FDECEC' },
  deleteButtonText: { fontFamily: 'Inter_600SemiBold', fontSize: 11, color: '#C0392B' },
  empty: { alignItems: 'center', justifyContent: 'center', paddingVertical: 60 },
  emptyIcon: { width: 58, height: 58, borderRadius: 18, backgroundColor: '#EEF3FF', alignItems: 'center', justifyContent: 'center' },
  emptyIconText: { color: '#356DFF', fontFamily: 'Inter_700Bold', fontSize: 27 },
  emptyTitle: { marginTop: 14, fontFamily: 'Inter_700Bold', fontSize: 18, color: '#172033' },
  emptyText: { marginTop: 6, fontFamily: 'Inter_400Regular', fontSize: 13, color: '#98A2B3', textAlign: 'center', maxWidth: 400 },
  emptyAddButton: { marginTop: 16, paddingHorizontal: 16, paddingVertical: 10, borderRadius: 10, backgroundColor: '#356DFF' },
  emptyAddButtonText: { color: '#FFFFFF', fontFamily: 'Inter_700Bold', fontSize: 12 },
