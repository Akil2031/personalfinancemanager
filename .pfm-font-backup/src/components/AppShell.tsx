    ...
    return (
      ...
      >
        <View style={styles.mobileHeader}>
          ...
          >
            <Text style={styles.mobileLogoutIcon}>â†ª</Text>
          ...
          <View style={styles.headerActions}>
            ...
            <View style={styles.profileWrapper}>
              ...
              >
                ...
                {isDesktop && <Text style={styles.profileChevron}>âŒ„</Text>}
              </Pressable>
              ...
              {profileOpen && (
                <View style={styles.profileMenu}>
                  ...
                  >
                    ...
                    <Text style={styles.logoutText}>{loggingOut ? 'Signing outâ€¦' : 'Logout'}</Text>
                  </Pressable>
                </View>
              )}
            </View>
            ...
            >
              <Text style={styles.headerLogoutIcon}>â†ª</Text>
