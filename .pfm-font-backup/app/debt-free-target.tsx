...
const styles = StyleSheet.create({
  ...
  loadingOrbText: { fontSize: 28, color: '#356DFF', fontWeight: '800' },
  loadingTitle: { marginTop: 18, fontSize: 18, fontWeight: '800', color: '#172033' },
  loadingText: { marginTop: 7, fontSize: 12, color: '#7A8496' },
  ...
  eyebrow: { fontSize: 10, fontWeight: '800', letterSpacing: 1.2, color: '#356DFF' },
  title: { fontSize: 31, fontWeight: '800', color: '#172033', letterSpacing: -0.5 },
  subtitle: { marginTop: 6, maxWidth: 760, fontSize: 13, lineHeight: 20, color: '#748095' },
  ...
  backButtonText: { fontSize: 12, fontWeight: '700', color: '#46536A' },
  ...
  metricLabelLight: { fontSize: 9, fontWeight: '800', letterSpacing: 0.8, color: 'rgba(255,255,255,0.78)' },
  ...
  metricIconText: { color: '#FFFFFF', fontSize: 14, fontWeight: '800' },
  metricValueLight: { marginTop: 17, fontSize: 27, fontWeight: '800', color: '#FFFFFF', letterSpacing: -0.5 },
  metricValueLightSmall: { marginTop: 18, fontSize: 20, fontWeight: '800', color: '#FFFFFF' },
  metricCaptionLight: { marginTop: 5, fontSize: 10, color: 'rgba(255,255,255,0.72)' },
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 14, gap: 20 },
  sectionEyebrow: { fontSize: 9, fontWeight: '800', letterSpacing: 1, color: '#7857D8' },
  sectionTitle: { marginTop: 4, fontSize: 20, fontWeight: '800', color: '#172033' },
  sectionHint: { fontSize: 10, color: '#8993A4' },
  ...
  cardIconTextBlue: { color: '#356DFF', fontSize: 17, fontWeight: '800' },
  cardIconTextOrange: { color: '#E99A32', fontSize: 18, fontWeight: '800' },
  cardTitle: { fontSize: 17, fontWeight: '800', color: '#172033' },
  helpText: { marginTop: 6, fontSize: 11, lineHeight: 18, color: '#7A8496' },
  inputLabel: { marginTop: 19, marginBottom: 7, fontSize: 9, fontWeight: '800', letterSpacing: 0.8, color: '#647086' },
  input: { height: 50, borderWidth: 1, borderColor: '#DCE2EC', borderRadius: 12, paddingHorizontal: 14, fontSize: 15, color: '#172033', backgroundColor: '#FAFBFD' },
  inputHint: { marginTop: 6, fontSize: 10, color: '#9AA4B5' },
  ...
  currencyPrefix: { paddingLeft: 15, fontSize: 18, fontWeight: '800', color: '#E99A32' },
  amountInput: { flex: 1, height: 50, paddingHorizontal: 10, fontSize: 16, color: '#172033' },
  ...
  plannedLabel: { fontSize: 11, color: '#7A8496' },
  plannedValue: { fontSize: 15, fontWeight: '800', color: '#18A673' },
  ...
  recommendationLabel: { flex: 1, fontSize: 10, color: '#6F7B90' },
  recommendationValue: { fontSize: 15, fontWeight: '800', color: '#356DFF' },
  recommendationActual: { fontSize: 13, fontWeight: '800', color: '#18A673' },
  recommendationRemaining: { fontSize: 13, fontWeight: '800', color: '#E99A32' },
  recommendationHint: { marginTop: 2, fontSize: 9, lineHeight: 14, color: '#98A2B3' },
  recalculationNote: { marginTop: 10, fontSize: 10, lineHeight: 15, color: '#172033' },
  ...
  projectionEyebrow: { fontSize: 9, fontWeight: '800', letterSpacing: 1, color: '#91AEFF' },
  projectionTitle: { marginTop: 5, fontSize: 22, fontWeight: '800', color: '#FFFFFF' },
  projectionSubtitle: { marginTop: 5, maxWidth: 650, fontSize: 11, lineHeight: 18, color: 'rgba(255,255,255,0.65)' },
  ...
  statusPillText: { fontSize: 10, fontWeight: '800', color: '#24304A' },
  ...
  projectionLabel: { fontSize: 9, fontWeight: '800', letterSpacing: 0.8, color: 'rgba(255,255,255,0.52)' },
  projectionDate: { marginTop: 8, fontSize: 31, fontWeight: '800', color: '#FFFFFF' },
  projectionMeta: { marginTop: 8, maxWidth: 600, fontSize: 11, lineHeight: 18, color: 'rgba(255,255,255,0.65)' },
  ...
  progressLabel: { fontSize: 10, color: 'rgba(255,255,255,0.65)' },
  progressStatus: { fontSize: 10, fontWeight: '800', color: '#FFFFFF' },
  ...
  progressFootText: { fontSize: 9, color: 'rgba(255,255,255,0.5)' },
  actionRow: { marginTop: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 20 },
  disclaimer: { flex: 1, maxWidth: 760, fontSize: 10, lineHeight: 16, color: '#8A94A5' },
